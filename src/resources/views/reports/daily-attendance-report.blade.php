        ...
        <div class="card-body">
            <form method="get" action="{{ route('hr-center.reports.daily-attendance-report-print') }}" target="_blank">
                <div class="row">
                    ...
                    <div class="col-md-3 mb-3">
                        <button type="submit" formaction="{{ route('hr-center.reports.daily-attendance-report') }}" formtarget="_self" class="btn btn-secondary btn-sm">Filter</button>
                        <a href="{{ route('hr-center.reports.daily-attendance-report') }}" class="btn btn-light btn-sm">Reset</a>
